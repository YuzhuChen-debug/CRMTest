...
<script type="text/javascript">
	$(function(){
		...
		$("#canrearchModalBtn").click(function () {
            $("#searchActivityModal").modal("hide");
        })

        $("#searchTest").keydown(function (event) {
            if(event.keyCode==13){
                //发送ajax请求,查询市场活动列表
                //alert(11);
				var name = $.trim($("#searchTest").val());
				//alert(name);
                $.ajax({
...
<body>
		...
		<div class="modal-dialog" role="document" style="width: 90%;">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" class="form-control" id="searchTest" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <input class="btn btn-primary" id="searchModalBtn" type="button" value="选择">
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <input class="btn btn-default" id="canrearchModalBtn" type="button" value="取消">
				</div>
			</div>
		</div>
	</div>
		...
		<form id="tranForm" action="workbench/Clue/clueTran.do" method="post">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    ...
		    <input type="text" class="form-control" id="activity" placeholder="点击上面搜索" readonly>
			  <input type="hidden" id="hiddenId" name="activityId"/>
		  </div>
		</form>
	...
	<div id="operation" style="position: relative; left: 40px; height: 35px; top: 100px;">
		<input class="btn btn-primary" type="button" id="btn" value="转换">
		&nbsp;&nbsp;&nbsp;&nbsp;
